...
$good = addProductAccessoriesEdit($connect);
?>
...
<?php include "../templates/menu_header_admin.php" ?>
    ...
    'id'
                ...
                <div style="text-align: center; margin-bottom: 30px;" >
                    <input style="width: 150px;" onclick="alert('Товар успешно обновлен!!!')" class="btn btn-primary" type="submit"  name="submitAccessories" value="Save">
                </div>
            </form>
            <div style="text-align: center; margin-bottom: 30px;" >
                <a href="../controllers/core_server_admin.php?userId=<?= $userId ?>&id=<?= $data[
    'id'
] ?>&action=deleteAccessories"><input style="background-color: red; width: 150px;" class="btn btn-primary" type="submit"  value="Delete_product"></a>
            </div>
            <?php } ?>
        </div>
    </main>
