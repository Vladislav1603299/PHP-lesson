...
<div class="header_top"></div>
    ...
    <div style="text-align: center; margin-bottom: 30px;" >
        <a href="add_scooters.php?userId=<?= $userId ?>"><input class="btn btn-primary" type="submit" value="Add product"></a>
    </div>
    <h1 class="products_name">ELECTRIC SCOOTERS</h1>
        <div style="flex-wrap:wrap; width:80%; margin: 0 auto" class="products">
            ...
            <a style="margin-top: 10px;" class="card_block" href="edit_product_scooter_card.php?userId=<?= $userId ?>&id=<?= $data[
    'id'
] ?>"><div class="card">
