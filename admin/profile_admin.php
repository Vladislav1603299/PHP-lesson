...
<?php include "../templates/menu_header_admin.php" ?>
    <main>
            ...
            <form action="../controllers/core_server_admin.php?userId=<?= $userId ?>" method="post"  enctype="multipart/form-data">
                <p class="profile_text"><strong style="margin-right: 70px; margin-left: 50px;">Your name:</strong> <input type="text" name="name" value="<?= $data[
                    'name_user'
                ] ?>"></p>
                <p class="profile_text"><strong style="margin-right: 47px; margin-left: 50px;">Your surname:</strong> <input type="text" name="surname" value="<?= $data[
                    'surname'
                ] ?>"></p>
                <p class="profile_text"><strong style="margin-right: 73px; margin-left: 50px;">Your login:</strong> <input type="text" name="login" value="<?= $data[
                    'login'
                ] ?>" required></p>
                ...
                <p class="profile_text"><strong style="margin-right: 70px; margin-left: 50px;">Your email:</strong> <input type="email" name="mail" value="<?= $data[
                    'email'
                ] ?>" required></p>
                <p class="profile_text"><strong style="margin-left: 50px;">Your phone number:</strong> <input type="tel" name="phone_number" value="<?= $data[
                    'phone_number'
                ] ?>"></p>
                <p class="profile_text"><strong style="margin-right: 55px; margin-left: 50px;">Your address:</strong> <input type="text" name="address" value="<?= $data[
                    'address'
                ] ?>"></p>
                <p class="profile_text"><strong style="margin-right: 59px; margin-left: 50px;">Your gender:</strong> <input type="text" name="experience" value="<?= $data[
                    'men_or_women'
                ] ?>"></p>
