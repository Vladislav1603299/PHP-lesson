...
<div class="header_top"></div>
    ...
    <div>
        ...
        $good = addProductAccessories($connect);
        while ($data = mysqli_fetch_assoc($good)) { ?>
        <form action="../server_website/core_website.php?userId=<?= $userId ?>&id=<?= $data[
    'id'
    ...
    'way_image3'
                ...
                <div class="product_card_text_price">
                    ...
                    <div class="input_by">
                        <input class="btn btn-primary" type="submit" name="addToBascetAccessories" value="Add to bascet">
                    </div>
                </div>
        </div>
        </form>
