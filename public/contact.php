...
<div class="header_top"></div>
    ...
    <main>
        <div class="main_contact">
            ...
            <p>Please be sure to check out the <a style="text-decoration: none; color: red;" href="FAQs.php">FAQ</a> page which will help answer some basic questions.</p>
            ...
            <form action="../admin/server/core_server_admin.php?userId=<?= $userId ?>" method="post"  enctype="multipart/form-data">
