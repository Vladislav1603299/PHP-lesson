...
<body>
    <header class="header">
        <h1 class="header_name">Моя галерея</h1>
        <a style="text-decoration: none; margin-right: 15px; color: white" href="feedback.php">Отзывы</a>
    </header>
    <main class="main">
    ...
    while ($data = mysqli_fetch_assoc($res)) { ?>
            <a href="fullfotos.php?id=<?= $data['id'] ?>&img=<?= $data[
    'name_foto'
] ?>"><img width="200px" height="100px" src="img/<?= $data[
    'name_foto'
] ?>" alt="foto"></a>
    <?php }
    ?>     
